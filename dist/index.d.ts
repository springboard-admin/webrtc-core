...
declare const RtcCall: ({ supabase, roomId, self, peerRole, signalingRole, selfName, features, slots, buildBridgeUrl, onLifecycle, onTelemetry, onCallEnd, }: RtcCallProps) => react.JSX.Element;
